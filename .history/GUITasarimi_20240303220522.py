...
import sys
from PyQt5.QtWidgets import QApplication, QMainWindow,QTabWidget, QWidget, QVBoxLayout, QLabel, QPushButton, QFileDialog,QMessageBox
...
class Odev2Page(QWidget):
    def __init__(self):
        ...
        # Ödev 1 için bir QLabel oluştur
        self.label = QLabel("Ödev 2 sayfası")
        self.label.setAlignment(Qt.AlignCenter)

        # QLabel'ı layouta ekle
...
class MainWindow(QMainWindow):
    ...
    def create_odev2_page(self):
        ...
        odev2_tab = Odev2Page()
        self.tab_widget.addTab(odev2_tab, "Ödev 2: Filtre Uygulama")
